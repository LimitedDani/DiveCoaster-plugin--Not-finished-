...
public class Kar11 {
	...
	private static Location rideLocation;
	private static int minecartCount = 2;
	private static Minecart[] minecarts;
	private static double minecartRotation;
	private static double minecartIncrementDegrees;
	private static double phi = 2*Math.PI / minecartCount;
	public Kar11(CommonEntity<?> Kar) {
